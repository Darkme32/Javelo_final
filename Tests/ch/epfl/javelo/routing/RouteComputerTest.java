...
class RouteComputerTest {
    ...
    private RouteComputer newCHWEST() {
        if (graph == null) {
            try {
    ...
    void routeComputerThrowsOnIdenticalStartAndEndNodes() {
        ...
        System.out.println(new RouteComputer(graph,cf).bestRouteBetween(159049,117669));
    }
    ...
    @Test
    void chwest() throws IOException {
        var rc = newCHWEST();
...
//    @Test
//    void chwest2() throws IOException {
//        var rc = newLausanneRouteComputer();
//        long t0 = System.nanoTime();
//
//        Route r = rc.bestRouteBetween(159040, 159041    );
//        System.out.printf("Itinéraire calculé en %d ms\n",
//                (System.nanoTime() - t0) / 1_000_000);
//
//        KmlPrinter.write("javelo.kml", r);
...
//    }
    ...
    @Test
    void routeComputerComputesCorrectRouteForGivenExample() throws IOException {
        var rc = newLausanneRouteComputer();

...
class MultiRouteTest {
    ...
    void multiRouteIndexOfSegmentAtWorksWithShallowRoutes() {
        ...
        assertEquals(5, m.indexOfSegmentAt(100000));
    }
    ...
    void multiRouteIndexOfSegmentAtWorksWithDeepRoutes() {
        ...
        assertEquals(3, m.indexOfSegmentAt((3 + 0.5) * 1000));
        assertEquals(1, m.indexOfSegmentAt((1 + 0.5) * 1000));
        assertEquals(4, m.indexOfSegmentAt((4 + 0.5) * 1000));
    ...
    void multiRoutePointClosestToWorksWithPointsOnRoute() {
        ...
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            ...
            assertEquals(pos, route.pointClosestTo(pt).position(), 1e-4);
